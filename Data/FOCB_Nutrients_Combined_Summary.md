...
<img src="FOCB_Nutrients_Combined_sum_files/figure-gfm/tn_din_plot_ammonium-1.png" style="display: block; margin: auto;" />
...
We first display \*\*all\* available data where `nh4_N` and `nox_N` are
